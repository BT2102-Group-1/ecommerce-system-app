...
def adminProductCatalogue():
  ...
  def displaySearchItems(productList):
    ...
    for modelDict in productList:     
      tk.Label(display_frame, bg="#F9FBF2", text="Model: " + modelDict[0] + ", Category: " + modelDict[1] + ", Price: " + modelDict[2]).grid(row=count, column=0, columnspan=4)
      count += 1
      tk.Label(display_frame, bg="#F9FBF2", text="Cost of Service: $" + modelDict[3] + ", Warranty: " + modelDict[4]).grid(row=count, column=0, columnspan=4)
      count += 1
      tk.Label(display_frame, bg="#F9FBF2", text="Number of Items Sold: " + modelDict[5] + ", Number of Items Unsold: " + modelDict[6]).grid(row=count, column=0, columnspan=4)
      count += 1
